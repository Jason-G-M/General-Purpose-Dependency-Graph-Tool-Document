...
If compatibility was set successfully, the CREATE button will be changed to UPDATE and you will see the figure below.  
...
### 4.4.3 One Shortest Path From Assembly to Type  
#### Usage  
